...
export class Test1Service {
    ...
    private resourceUrl =  SERVER_API_URL + 'masternodesonlinesupplementapi/api/test-1-s';
    private resourceSearchUrl = SERVER_API_URL + 'masternodesonlinesupplementapi/api/_search/test-1-s';
